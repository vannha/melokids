...
add_filter( 'vc_autocomplete_zkposts_grid_taxonomies_callback', 'vc_autocomplete_taxonomies_field_search', 10, 1 );
add_filter( 'vc_autocomplete_zkposts_grid_taxonomies_render', 'vc_autocomplete_taxonomies_field_render', 10, 1 );

vc_map(array(
    'name'        => 'MeloKids Posts Grid',
    'base'        => 'zkposts_grid',
        ...
        array(
        	array(
				...
				'value'      =>  array(
                    ...
                    '3' => get_template_directory_uri().'/vc_customs/layouts/posts_grid3.png',
                    '2' => get_template_directory_uri().'/vc_customs/layouts/posts_grid2.png',
	            ),
				'std'   => '1',
...
class WPBakeryShortCode_zkposts_grid extends CmsShortCode{
