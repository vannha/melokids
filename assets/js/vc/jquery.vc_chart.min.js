! function($) {
    ...
    VcChart.prototype = {
        ...
        draw: function(redraw) {
            var radius, 
            	w = this.$el.addClass("vc_ready").width(),
            	color = this.$el.data('pie-color')
            ;
            w || (w = this.$el.parents(":visible").first().width()), w = w / 100 * 100, radius = w / 2 - 3, this.$wrapper.css({
                width: w + "px"
            }), this.$label.css({
                width: w,
                height: w,
        ...
        setWayPoint: function() {
            void 0 !== $.fn.waypoint ? this.$el.waypoint($.proxy(this.animate, this), {
                offset: "85%"
            }) : this.animate()
        }
        ...
        return this.each(function() {
            ...
            void 0 === option && $this.data("vc_chart", data = new VcChart(this, options)), "string" == typeof option && data[option](value)
        })
